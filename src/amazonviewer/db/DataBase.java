...
public class DataBase {
    ...
    public static final String URL_ ="jdbc:mysql://localhost:3306/amazonviewer?user=amazonviewer&password=S@c_rK3s-5aT1WyI";
    public static final String DB       = "amazonviewer";
    public static final String USER     = "amazonviewer";
    public static final String PASSWORD = "S@c_rK3s-5aT1WyI";
